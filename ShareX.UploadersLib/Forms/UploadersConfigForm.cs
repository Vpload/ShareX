...
namespace ShareX.UploadersLib
{
    public partial class UploadersConfigForm : Form
    {
        ...
        private void FormSettings()
        {
            ...
            AddIconToTab(tpVpload, Resources.Vpload);
...
- You can now authenticate to Jira", Links.URL_WEBSITE, "ShareX", APIKeys.JiraConsumerKey, Jira.PublicKey);
            ...
            txtVploadHost.Text = Config.VploadHost;
            txtVploadKey.Text = Config.VploadKey;
        ...
        private void txtVploadHost_TextChanged(object sender, EventArgs e)
        {
            Config.VploadHost = txtVploadHost.Text;
        }

        private void txtVploadKey_TextChanged(object sender, EventArgs e)
        {
            Config.VploadKey = txtVploadKey.Text;
        }
