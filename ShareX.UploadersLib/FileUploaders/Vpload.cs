...
{
    /*
     * Vpload is an encrypted image uploader. The idea is that any URL (for example, https://vpload.com/#hsd2mdSuIkzTUR6saZpn1Q) contains
    ...
    public sealed class Vpload : FileUploader
    {
        ...
        public Vpload(string systemUrl, string apiKey)
        {
            if (string.IsNullOrEmpty(systemUrl))
            {
                SystemUrl = "https://vpload.com";
            }
            else
            {
                SystemUrl = systemUrl;
        ...
        public override UploadResult Upload(Stream input, string fileName)
        {
            ...
            {
                throw new ArgumentException("Input files for Vpload cannot be more than 50MB in size.");
            }
            ...
            if (result.IsSuccess)#region License Information (GPL v3)
    ...
    public sealed class Vpload : FileUploader
    {
        ...
        public override UploadResult Upload(Stream input, string fileName)
        {
            ...
            if (result.IsSuccess)
            {
                ...
                VploadResponse response = JsonConvert.DeserializeObject<VploadResponse>(result.Response);
